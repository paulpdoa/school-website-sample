            ...
            <div className="max-w-7xl px-16 py-16 w-full">
                ...
                >
                    ...
                    <div className="grid lg:grid-cols-4 gap-5 justify-items-center py-10">
                        ...
                        <Link className="service-card" to='/enrollment'>
                            ...
                            <p className="font-medium text-sm p-1">New Student Application for Admission</p>
                        </Link>
                        ...
                        <Link to='#' className="service-card">
                            ...
                            <p className="font-medium text-sm p-1">Online Enrollment</p>
                        </Link>
                        <Link to='#' className="service-card">
                            <svg className="service-icon" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="font-medium text-sm p-1">Intent / Reservation Form for SY 2021-2022(Current Students Only)</p>
                        </Link>
                        <Link to='#' className="service-card">
                            <svg className="service-icon" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="font-medium text-sm p-1">Online Document Requisition</p>
                        </Link>
                    </div>
                </div>
            </div>

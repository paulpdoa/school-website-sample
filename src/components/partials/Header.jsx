            ...
            <div className="max-w-7xl grid grid-rows-1 w-full">
                <div className="lg:grid lg:grid-cols-6 gap-5 justify-start py-5 lg:px-16">
                    ...
                    <div className="lg:col-span-1 flex lg:justify-around justify-center gap-2 items-center"> {/* contact btn ang login btn */}
                        <Link to='/contact-us' className="Btn bg-blue-900 text-gray-100 text-xs font-semibold p-2 lg:w-auto w-28 justify-center flex items-center">
                            CONTACT US
                        ...
                        <Link to='/login' className="Btn bg-blue-900 text-gray-100 text-xs font-semibold p-2 lg:w-auto w-28 justify-center flex items-center">
                            LOGIN
                            <svg className="w-5 h-5 arrow text-gray-100" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
                            </svg>
